...
因為我所待的產品團隊還在團隊規模較小、正在快速成長的階段<br>可以接觸到產品從 0 到 1 的整個過程，<br>
...
- 一個樂於分享、接受提問的團隊
    ...
    - 這邊必須推一個我們前端工程師寫的「與工程師協作的先備知識」（一定要看！超推✨）  
        ...
        - [第二篇](https://blog.errorbaker.tw/posts/xiang/cooperate-with-engineer-part2/)：了解工程師思維、如何透過證據跟工程師溝通，會讓你對 Bug Issue 更清楚。
